...
# 6289 List 13
list13 = []
[list13.append(int(x)) for x in list(input("리스트 13번 입력 : "))]
...
# 6290 List 14 뭔지 모르겠으니 패스...

# 6292 List 16
list16 = []
str16 = input("리스트 16번 입력 : ").split(",")
list16 = list(str16)
tuple16 = tuple(list16)
print(list16)
print(tuple16)
...
from math import *
list17 = []
str17 = input("리스트 17번 입력: ").split(",")
print(str17)
for i in str17:
    list17.append(int(i)*pi*2)

for i in list17[:-1]:
    print("{:0.2f}".format(i), end=", ")
print("{:0.2f}".format(list17[-1]))
